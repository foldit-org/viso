...
shader_registry! {
    ...
    SelectSphere   => "raster/impostor/select_sphere.wgsl",
    Cone           => "raster/impostor/cone.wgsl",
    Lightning      => "raster/impostor/lightning.wgsl",
    Grease         => "raster/impostor/grease.wgsl",
